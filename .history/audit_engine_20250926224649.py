...
def parse_ejari_text(text: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "property_type": ptype,
        "clauses": clauses,
        # NOTE: We do NOT return a reconstructed text — the app shows verbatim `text`.
    }
...
def audit_contract(
    *,
    ...
    verdict = "pass" if (not highlights and not rule_flags and all(c["verdict"]=="pass" for c in clause_results)) else "fail"
